...
const VersionSkeleton = () => (
  <span className="inline-block h-4 w-10 animate-pulse rounded bg-sage-300/50"></span>
);
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mb-8 inline-flex items-center gap-2 rounded-full bg-sage-100 px-4 py-2 text-sm font-medium text-sage-700">
            ...
            <span className="flex items-center gap-2">
              {loading ? <VersionSkeleton /> : version && <span className="text-xs opacity-75">v{version}</span>}
              {(loading || version) && <span className="text-gray-400">|</span>}
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            >
              ...
              {browser}에 추가하기
              {loading ? (
                <span className="inline-block h-3 w-8 animate-pulse rounded bg-white/30"></span>
              ) : (
